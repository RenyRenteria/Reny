        ...
        <div class="community-shell">
            <aside class="sidebar" aria-label="Primary navigation">
                <div>
                    ...
                    <nav class="tabs" aria-label="Main menu">
                        ...
                        <a class="tab is-active" href="{{ $siteEditorNavHref('community', '/community') }}" @if ($siteEditorPreview) target="_top" @endif aria-current="page">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
            ...
            <main class="main-content community-content" id="community">
                ...
                <nav class="mobile-bottom-nav" aria-label="Mobile menu">
                    ...
                    <a class="is-active" href="{{ $siteEditorNavHref('community', '/community') }}" @if ($siteEditorPreview) target="_top" @endif aria-current="page">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                            <path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"></path>
                        </svg>
