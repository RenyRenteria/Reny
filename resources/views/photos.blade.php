        ...
        <div class="photos-shell">
            <aside class="sidebar" aria-label="Primary navigation">
                <div>
                    ...
                    <nav class="tabs" aria-label="Main menu">
                        ...
                        <a class="tab is-active" href="{{ $siteEditorNavHref('photos', '/photos') }}" @if ($siteEditorPreview) target="_top" @endif aria-current="page">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
            ...
            <main class="main-content photos-content" id="photos">
                ...
                <nav class="mobile-bottom-nav" aria-label="Mobile menu">
                    ...
                    <a class="is-active" href="{{ $siteEditorNavHref('photos', '/photos') }}" @if ($siteEditorPreview) target="_top" @endif aria-current="page">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                            <rect x="3" y="3" width="18" height="18" rx="2"></rect>
                            <circle cx="8.5" cy="8.5" r="1.5"></circle>
                            <path d="m21 15-5-5L5 21"></path>
